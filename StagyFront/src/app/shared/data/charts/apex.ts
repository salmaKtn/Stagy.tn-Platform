...
export let barChart: ChartOptions | any = {
  ...
  xaxis: {
    categories: ["Zaghouan", "Sfax", "Djerba", "Monastir", "Gafsa", "Sousse", "Ariana", "Tunis", "Mahdia", "LA Marsa"],
    show: false,
    labels: {
      show: false,
    },
...
export let donutChart: ChartOptions | any = {
  ...
  labels: ["L abel1", "Label 2", "Label 3", "Label 4", "Label 5"],
  responsive: [
    {
      breakpoint: 480,
      options: {
...
export let mixedChart: ChartOptions | any = {
  ...
  colors: [secondary_color, "#425d13ff", primary_color],
};

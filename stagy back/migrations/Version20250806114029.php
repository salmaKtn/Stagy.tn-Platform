 ...
 */
final class Version20250806114029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, roles LONGTEXT DEFAULT NULL, working_hours VARCHAR(255) DEFAULT NULL, payment INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, duration VARCHAR(255) DEFAULT NULL, governorate VARCHAR(255) DEFAULT NULL,  image VARCHAR(255) DEFAULT NULL,category VARCHAR(255) DEFAULT NULL, process_step VARCHAR(255) DEFAULT NULL, INDEX IDX_29D6873E979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
